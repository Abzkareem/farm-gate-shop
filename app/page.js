    ...
    <>
      ...
      <section id="top" className="relative overflow-hidden text-cream text-center pt-24 pb-0 px-6" style={{ backgroundImage: "linear-gradient(rgba(20,26,15,0.6), rgba(20,26,15,0.65)), url(/images/hero.jpg)", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="relative max-w-2xl mx-auto pb-24">
          <p className="uppercase tracking-widest text-gold text-sm font-bold mb-3">Poultry &amp; Livestock · Abuja</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {products.map((product) => (
              <div key={product.id} className="bg-card border border-soil/25 rounded-xl overflow-hidden flex flex-col hover:-translate-y-1 hover:shadow-xl hover:shadow-forest/10 transition">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <p className="font-display font-bold text-xl text-barn-red mb-1">₦{product.price.toLocaleString()}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <ul className="space-y-5">
              ...
              <li className="flex gap-3 items-start">
                ...
                <div>
                  <p className="text-xs uppercase tracking-wide text-gold/80">Location &amp; Delivery</p>
